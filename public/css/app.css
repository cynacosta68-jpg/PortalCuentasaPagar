...
.nav-link:hover { background: var(--sidebar-hover); color: #d0d8ec; }
...
.table tbody tr:hover { background: #f7f8fb; }
...
.form-control:focus {
  ...
  box-shadow: 0 0 0 3px rgba(39,64,139,.1);
}
...
.badge-en_corrida     { background: var(--info-bg);    color: var(--accent); }
.badge-pagado         { background: var(--success-bg); color: var(--success); }
.badge-anulado        { background: var(--bg);         color: var(--text-muted); border: 1px solid var(--border); }
.badge-borrador       { background: var(--bg);         color: var(--text-muted); border: 1px solid var(--border); }
.badge-pendiente_aprob{ background: var(--warning-bg); color: var(--warning); }
.badge-aprobada       { background: var(--info-bg);    color: var(--accent); }
.badge-ejecutada      { background: var(--success-bg); color: var(--success); }
...
.alert-error   { background: var(--danger-bg);  color: var(--danger);  border-color: #f5b8b8; }
.alert-success { background: var(--success-bg); color: var(--success); border-color: #a3d9b8; }
.alert-info    { background: var(--info-bg);    color: var(--accent);  border-color: #c5d3f0; }
...
.logout-btn:hover { background: var(--sidebar-hover); color: #f3b0b0; }
...
.login-body {
  ...
  justify-content: center;
  min-height: 100vh;
  background: linear-gradient(135deg, #1b2340 0%, #27408b 100%);
  padding: 20px;
}
